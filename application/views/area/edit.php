<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('area/edit/'.$area['person_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="level" class="form-control">
								...
								{
									$selected = ($person['person_id'] == $area['level']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="years" value="<?php echo ($this->input->post('years') ? $this->input->post('years') : $area['years']); ?>" class="form-control" id="years" />
