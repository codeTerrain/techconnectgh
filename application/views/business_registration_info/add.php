    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Business Registration Info Add</h3>
            </div>
            <?php echo form_open('business_registration_info/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="path_of_file" value="<?php echo $this->input->post('path_of_file'); ?>" class="form-control" id="path_of_file" />
