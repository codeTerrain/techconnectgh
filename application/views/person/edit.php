			...
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="salutation" class="form-control">
								...
								{
									$selected = ($value == $person['salutation']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="educational_level" class="form-control">
								...
								{
									$selected = ($value == $person['educational_level']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="marital_status" class="form-control">
								...
								{
									$selected = ($value == $person['marital_status']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="date_of_birth" class="form-control">
								<option value="">select</option>
								<?php 
								$date_of_birth_values = array(
								);

								foreach($date_of_birth_values as $value => $display_text)
								{
									$selected = ($value == $person['date_of_birth']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="other_name" value="<?php echo ($this->input->post('other_name') ? $this->input->post('other_name') : $person['other_name']); ?>" class="form-control" id="other_name" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="phone" value="<?php echo ($this->input->post('phone') ? $this->input->post('phone') : $person['phone']); ?>" class="form-control" id="phone" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="postal_address" value="<?php echo ($this->input->post('postal_address') ? $this->input->post('postal_address') : $person['postal_address']); ?>" class="form-control" id="postal_address" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="website" value="<?php echo ($this->input->post('website') ? $this->input->post('website') : $person['website']); ?>" class="form-control" id="website" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="linkedIn" value="<?php echo ($this->input->post('linkedIn') ? $this->input->post('linkedIn') : $person['linkedIn']); ?>" class="form-control" id="linkedIn" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="facebook" value="<?php echo ($this->input->post('facebook') ? $this->input->post('facebook') : $person['facebook']); ?>" class="form-control" id="facebook" />
				...
				<div class="col-md-6" >
						...
						<div class="form-group">
							<input type="text" name="specify" value="<?php echo ($this->input->post('specify') ? $this->input->post('specify') : $person['associatedCompanyId']); ?>" class="form-control" id="specify" disabled="true"/>
