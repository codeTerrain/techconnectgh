    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
                  <h2 class="box-title">Add New Member To <?php echo ($this->input->post('company_name') ? $this->input->post('company_name') : $company['company_name']); ?></h2>
                  </div>
                 
						
					
            
            <?php echo form_open('company/addMember/'.$company['company_id']); ?>

            <div class="col-md-6">
						<label for="spec" class="control-label"><span class="text-danger">*</span>Associated Company Id</label>
						<div class="form-group">
							<input type="text" name="spec" value="<?php echo ($this->input->post('spec') ? $this->input->post('spec') : $company['company_id']); ?>" class="form-control" id="spec" readonly/>
